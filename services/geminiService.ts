...
export const generateNextSpinner = async (
  ...
  try {
    // Fix: Using gemini-3-pro-preview for complex coding tasks as per guidelines
    const streamResult = await ai.models.generateContentStream({
      ...
      config: {
        ...
        // Fix: Use thinkingBudget instead of thinkingLevel as per Gemini API guidelines. 
        // 0 disables thinking for lower latency as intended by 'MINIMAL'
